                ...
                <div className="card-item">
                    ...
                    <span>
                        <div className="card-lable" >
                            ...
                            <input id="email" type="username" placeholder="Email" className="card-input1" width= "350px"
                                onChange = {e => setUsername(e.target.value)}/>
                        </div>
                ...
                <div className="card-item">
                    ...
                    <span>
                        <div className="card-lable" >
                            ...
                            <input id="pass" type="password" placeholder="**********"  className="card-input1" width="350px"
                                onChange = {e => setPassword(e.target.value)}/>
                        </div>
                    </span>
                </div>
